    ...
    emailjs
      .send(
        ...
        'template_zo78p85', // paste your TemplateID here (you'll find it under email templates).
        {
          ...
          to_email: 'saravan.pathapati@gmail.com', //put your email here.
          message: form.message,
        },
        'ftvXwK146dwkMZEip' //paste your Public Key here. You'll get it in your profile section.
      )
      .then(
        () => {
          setLoading(false);
        ...
        (error) => {
          ...
          if (error.text) {
            ...
            alert('Something went wrong. Please check the console for more details and try again.');
          }
        }
      );
  };
